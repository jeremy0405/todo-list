...
enum ServerAPI {
    ...
    case postVertical(id: String)
    case postHorizon(id: String)
    ...
    var url: URL? {
        ...
        case .postVertical(let id):
            return URL(string: Self.baseURL + "/" + "vertical/" + id)
        case .postHorizon(let id):
            return URL(string: Self.baseURL + "/" + "horizon/" + id)
        case .patch(let id):
            return URL(string: Self.baseURL + "/" + id)
        }
    }
